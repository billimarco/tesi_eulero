...
public class BuildCorrectGraphTest {
    ...
    public void createServiceMeshOfGraph1(){
        ...
        HashMap<String,Microservice> ms = Orchestrator.createServiceMesh(mst_1,new ArrayList<MicroserviceType>(Arrays.asList(mst_1, mst_3, mst_4)), cloud, edge);
    ...
    public void createServiceMeshOfGraph2(){
        ...
        HashMap<String,Microservice> ms = Orchestrator.createServiceMesh(mst_1,new ArrayList<MicroserviceType>(Arrays.asList(mst_1, mst_3)), cloud, edge);
    ...
    public void createServiceMeshOfGraph3(){
        ...
        mst_1.addConnection(mst_2, 10);
        mst_1.addConnection(mst_3, 25);
        HashMap<String,Microservice> ms = Orchestrator.createServiceMesh(mst_1,new ArrayList<MicroserviceType>(Arrays.asList(mst_1,mst_2,mst_3)), cloud, edge);
    ...
    public void createServiceMeshOfGraph5(){
        ...
        HashMap<String,Microservice> ms = Orchestrator.createServiceMesh(mst_1,new ArrayList<MicroserviceType>(Arrays.asList(mst_2,mst_3)), cloud, edge);
