...
public class MicroserviceTest {
    ...
    public void initMethod() {
        mst_1 = new MicroserviceType("1", true,new TruncatedExponentialTime(1,3,5),new Resources(1, 1));
        mst_2 = new MicroserviceType("2", false,new TruncatedExponentialTime(1,3,5),new Resources(1, 1));
        mst_3 = new MicroserviceType("3", false,new TruncatedExponentialTime(1,3,5),new Resources(1, 1));
        res_cloud = new Resources(12, 16);
        cloud = new CloudLocation(res_cloud);
        ms_1 = new Microservice(0, mst_1, cloud,new Resources(2,2));
        ms_2 = new Microservice(0, mst_2, cloud,new Resources(0,0));
        ms_3 = new Microservice(0, mst_3, cloud,new Resources(1,1));
    }
